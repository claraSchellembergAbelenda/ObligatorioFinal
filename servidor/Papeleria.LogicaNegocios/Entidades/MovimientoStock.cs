...
namespace Papeleria.LogicaNegocios.Entidades
{
    public class MovimientoStock : IValidable <MovimientoStock>
    {
        ...
        public MovimientoStock(int id, DateTime fechaYHora, Articulo articuloMovido, TipoMovimiento tipoMovimiento, string email, int cantUnidadesMovidas)
        {
            this.id = id;
